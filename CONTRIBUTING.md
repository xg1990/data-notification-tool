...
Welcome to `data-notification-tool` contributor's guide.
...
If you experience bugs or general issues with `data-notification-tool`, please have a look
...
You can help improve `data-notification-tool` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`data-notification-tool` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `data-notification-tool`'s files. While this mechanism can
...
```
conda create -n data-notification-tool python=3 six virtualenv pytest pytest-cov
conda activate data-notification-tool
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/data-notification-tool.git
   cd data-notification-tool
   ```
...
5. Install [pre-commit]:
   ...
   `data-notification-tool` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/data-notification-tool
[issue tracker]: https://github.com/<USERNAME>/data-notification-tool/issues
