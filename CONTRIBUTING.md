...
Welcome to `dnt` contributor's guide.
...
If you experience bugs or general issues with `dnt`, please have a look
...
You can help improve `dnt` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`dnt` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `dnt`'s files. While this mechanism can
...
```
conda create -n dnt python=3 six virtualenv pytest pytest-cov
conda activate dnt
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/dnt.git
   cd dnt
   ```
...
5. Install [pre-commit]:
   ...
   `dnt` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/dnt
[issue tracker]: https://github.com/<USERNAME>/dnt/issues
